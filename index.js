    ...
    <div className="bg-white text-gray-900 min-h-screen font-sans">
      ...
      <main className="p-6 max-w-6xl mx-auto space-y-8">
        ...
        <section className="bg-gray-100 p-6 rounded-lg text-center">
          ...
          <p className="mb-4 text-gray-600">Join our newsletter and get the latest stock insights to your inbox.</p>
          <div className="flex justify-center gap-2">
            <input type="email" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} className="border p-2 rounded w-64" />
            <button onClick={handleSubscribe} className="bg-blue-700 text-white px-4 py-2 rounded">Subscribe</button>
          </div>
        </section>
